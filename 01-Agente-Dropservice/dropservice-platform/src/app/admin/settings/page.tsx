...
import { Building2, CreditCard, Package as _Package } from 'lucide-react';
    ...
    return (
        <div className="space-y-6">
            ...
            <Tabs defaultValue="general" className="space-y-6">
                <TabsList className="w-full max-w-xl h-11 p-1 bg-muted/50 border border-border/50 rounded-lg flex items-center gap-1 mx-auto lg:mx-0">
