...
export const MOCK_LOTES: Lote[] = [
  {
    ...
    tamanoLote: 'palet_completo',
    formatoVenta: 'subasta_estandar',
    msrpTotal: 4500000,
    precioCompraYa: 1490000,
    manifestUrl: '/manifests/FAL-2026-001.pdf',
    terminoDespacho: 'despacho_liquidar',
  ...
  },
  {
    ...
    condicion: 'nuevo',
    tamanoLote: 'palet_completo',
    formatoVenta: 'sobre_cerrado',
    msrpTotal: 1850000,
    manifestUrl: '/manifests/PAR-2026-045.pdf',
    terminoDespacho: 'flete_comprador',
